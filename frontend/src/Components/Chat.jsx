...
import { ActiveDot, Avatar, InActiveDot, Text, UploadImage } from './CommonComponent.jsx';
    ...
    return (
        <ChatContext.Provider value={defaultContextValue}>
            ...
            <div
                ...
                <div className='overflow-y-scroll p-[10px]'>
                    {
                        ...
                        ci.messages.slice(0).reverse().map(message => (
                            <Message key={message.message_id} from={message.sender_id == me.user_id ? 'me' : 'you'}
                                     avatar_src={message.sender_id == me.user_id ? me.avatar : ci.recipient_avatar}
                ...
                <div
                    className={`flex p-[10px_20px] items-end  border-t-[1px] border-solid border-[${Color.BorderGray}]`}>
                    <div className='flex  items-center'>
                        <div onClick={ToggleEmoji} className='mx-[5px] cursor-pointer'>
                        ...
                        <div className='cursor-pointer mx-[5px] '>
