...
import { markAsReadAsync, updateMessage } from '../../Reducers/Contacts';
...
export function ChatV2({ contact: ci }) {
    ...
    let className = twMerge(` shadow-v1 rounded-[15px] relative flex flex-col  bottom-0  h-full   bg-[${Color.White}]`);
